...
const ApplicantProfile = () => {
  ...
  const handleCopy = (driveUrl, fileName = "resume.pdf") => {
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
              <div className="relative">
                <div className="w-24 h-24 bg-teal-500 rounded-full flex items-center justify-center text-white text-2xl font-semibold">
                  ...
                  <img src={candidate.candidate_image_link} className="w-full h-full rounded-full" alt="" />
                </div>
              ...
              <div className="flex-1 w-full">
                <div className="flex flex-col sm:flex-row justify-between items-start">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 mt-4 sm:mt-0 w-full sm:w-auto">
                    <button
                      onClick={()=>handleCopy(candidate.candidate_resume_link)}
